...
var propertyCheckerHelper = function propertyCheckerHelper(prop) {
  return new Promise(function (res, rej) {
    var modifierFunction = function modifierFunction(state) {
...
describe("addPrerun", function () {
  it("should call the function passed to prerun", _asyncToGenerator(regeneratorRuntime.mark(function _callee6() {
    var mockFn;
  ...
  it("should wait at least 100ms on a promise passed to prerun", _asyncToGenerator(regeneratorRuntime.mark(function _callee7() {
    var mockFn;
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            ...
            addPrerun(new Promise(function (resolve) {
